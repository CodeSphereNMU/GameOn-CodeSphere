...
/**
 * Seeds test data when running with 'local' or 'test' profile (H2 database).
...
public class DataInitializer {
    ...
    public CommandLineRunner initData(SportRepository sportRepository,
        ...
        return args -> {
            logger.info("Initializing seed data for local/test profile...");
            ...
            logger.info("Seed data initialized: 5 sports, 12 positions, 10 formats, 6 users, 8 sport profiles");
